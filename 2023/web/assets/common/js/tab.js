...
layui.define(['jquery', 'element', 'nprogress', 'utils'], function (exports) {
    ...
    var Tab = function () {
        this.config = {
            elem: undefined,
            mainUrl: 'board.html?_=' + Math.random(),
            renderType: 'iframe',
            openWait: true
        };
        this.v = '1.0.5';
    ...
    var _tab = {
        ...
        createTabDom: function () {
            ...
            var tpl = [
                    ...
                    '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="layui-icon">&#xe68e;</i> 公告</li>',
                    '</ul>',
                    '<div class="kit-tab-tool">操作&nbsp;<i class="fa fa-caret-down"></i></div>',
                    '<div class="kit-tab-tool-body layui-anim layui-anim-upbit">',
                    '<ul>',
                    '<li class="kit-item" data-target="refresh" id="refreshBtn">刷新当前选项卡</li>',
